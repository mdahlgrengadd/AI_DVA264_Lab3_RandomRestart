...
def pretty_print_neighbours(currentSolution, neighbours):
    print("Initial solution:     ", currentSolution,
          f"Fitness: {calculateFitness(currentSolution)}")
    ...
    fitnesses = [calculateFitness(neighbour) for neighbour in neighbours]
